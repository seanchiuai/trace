    ...
    <>
      ...
      {findings.length > 0 && (
        <button
          ...
          className="fixed bottom-16 right-5 z-30 -translate-y-2 flex items-center gap-1.5 px-3 py-1.5 rounded-full glass-accent hover:bg-accent/[0.08] transition-colors cursor-pointer"
          style={{
            display: visibleToasts.length > 0 ? "none" : "flex",
          }}
        >
